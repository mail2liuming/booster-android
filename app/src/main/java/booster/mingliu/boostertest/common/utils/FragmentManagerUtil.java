...
public class FragmentManagerUtil {
    ...
    private static final Logger logger = Logger.getLogger(FragmentManagerUtil.class.getName());


    /**
     * Adds the received {@link Fragment} in the container view with id "fragment_container".
     *
     * @param activity    {@link Activity} that will contain the {@link Fragment}.
     * @param fragment    {@link Fragment} to be added.
     * @param fragmentTag Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void addFragment(BasicActivity activity, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     *
     * @param activity        {@link Activity} that will contain the {@link Fragment}.
     * @param containerViewId Id of the container view where the fragment will be added.
     * @param fragment        {@link Fragment} to be added.
     * @param fragmentTag     Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void addFragment(BasicActivity activity, int containerViewId, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     * @param fragmentTag Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void addFragmentAndAddToBackStack(BasicActivity activity, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     * @param fragmentTag     Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void addFragmentAndAddToBackStack(BasicActivity activity, int containerViewId, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     *
     * @param activity    {@link Activity} that will contain the {@link Fragment}.
     * @param fragment    {@link Fragment} to be added, that will replace the current one.
     * @param fragmentTag Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void replaceFragment(BasicActivity activity, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     * @param fragmentTag Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void replaceFragmentAndAddToBackStack(BasicActivity activity, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     *
     * @param activity        {@link Activity} that will contain the {@link Fragment}.
     * @param containerViewId Id of the container view where the new fragment will replace the current one.
     * @param fragment        {@link Fragment} to be added, that will replace the current one.
     * @param fragmentTag     Tag of the {@link Fragment} to add, used to identify it.
     */
    public static void replaceFragment(BasicActivity activity, int containerViewId, Fragment fragment, String fragmentTag, @Animation int animation) {
     ...
     * @param fragment        {@link Fragment} to be added, that will replace the current one.
     * @param fragmentTag     Tag of the {@link Fragment} to add, used to identify it.
     * @param addToBackStack  {@code true} if the {@link Fragment} should be added to the back stack, or {@code false} if it shouldn't.
     * @param replace         {@code true} if the current {@link Fragment} should be replaced, or {@code false} if it shouldn't.
     */
    private static void showFragment(BasicActivity activity, int containerViewId, Fragment fragment, String fragmentTag, boolean addToBackStack, boolean replace, @Animation int animation) {
